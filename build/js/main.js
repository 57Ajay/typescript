...
const guitarist = new classes_1.Guitarist1("Ajay", "Guitar");
guitarist.play("playing guitar");
const peeps = new classes_1.Peeps("Ajay");
console.log(peeps.id);
console.log(classes_1.Peeps.getCount());
const bands = new classes_1.Bands();
